        ...
        try {
          ...
          try {
            ...
            if (json.results && Array.isArray(json.results) && json.results.length > 0) {
              // Extract primary key for correlation
              primaryKey = json.results[0].key;
          ...
          // We store the suggestion details (correlationText) instead of the triggering prompt
